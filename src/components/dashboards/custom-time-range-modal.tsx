...
import {
  ...
  ModalSubmitFooter,
  ModalTitle,
} from '../console/factory/modal';
import { toISODateString, twentyFourHourTime } from '../console/utils/datetime';
...
const CustomTimeRangeModal = ({ cancel, close, activePerspective }: CustomTimeRangeModalProps) => {
  ...
  return (
    <form onSubmit={submit} name="form" className="modal-content">
      ...
      <ModalSubmitFooter cancel={cancel} submitText={t('public~Save')} />
    </form>
  );
};
